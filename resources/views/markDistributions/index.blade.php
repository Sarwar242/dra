    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 title-bar">
                <h1><i class="fa fa-building-o"></i> MarkDistributions</h1>
            </div>
            ...
            <div class="col-xs-12 rms-data-table">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">MarkDistributions List</h3>
                    </div>
        ...
        jQuery(document).on("click", ".deleteMarkDistribution", function(){
            ...
            if(confirmation)
            {
                ...
                data : { id : Id }
                    ...
                    if(data.status = true) { console.log("MarkDistribution successfully deleted"); }
                    else if(data.status = false) { console.log("MarkDistribution delete failed"); }
