<div class="modal" id="modal0" tabindex="-1" data-backdrop="false" role="dialog">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="{{ route('mark.input') }}">
            @csrf
            <div class="modal-body">
                ...
                <div class="form-group col-sm-6 offset-sm-3">
                    ...
                    <select class="form-control selectpicker" name="student_id" id="student" required>
                        <option value="" disabled selected>Select One</option>
                    </select>
                </div>
            </div>
